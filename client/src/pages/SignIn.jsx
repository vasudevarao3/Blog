  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      if (data.success === false){
        setLoading(false);
        return setErrorMessage(data.message);//setErorMessage("Username name exist, Try another.")
      }
      setLoading(false);
      if(res.ok){
        navigate('/');
      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5"> 
        ...
        <div className="flex-1">
          ...
          <p className='text-sm mt-5'>
            ...
            You Have Multiple Options to Sign In with your email, password and 
            Sign Up using Username,email and Password or with Google.
          </p>
        </div>
        {/* right */}
        <div className="flex-1">
